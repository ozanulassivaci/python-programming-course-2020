...
# Generated by pyuic5 from _checkbox.ui (built visually in Qt Designer) --
# see MainWindow.py for the full explanation of what a generated UI file is
# and why you never hand-edit one. The actual behavior lives in _checkbox.py,
# which imports Ui_MainWindow from here.
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        # QGroupBox is a container widget drawn with a titled border around
        # it (like "Hobbies" boxes you see in installer wizards) -- it's
        # used here purely to visually group a set of related checkboxes,
        # and also gives us a convenient object (self.group_hobbies) to
        # search through later with findChildren() in _checkbox.py.
        ...
        # A plain QWidget nested inside the group box, whose only job is to
        # host a QVBoxLayout (see layouts.py for what QVBoxLayout does) so
        # the checkboxes below stack neatly instead of needing manual
        # move() calls.
        ...
        # QCheckBox is a widget with a small box that the user can click to
        # toggle between checked/unchecked -- unlike QRadioButton (used in
        # _radiobutton.py), any number of checkboxes in a group can be
        # checked at once; they're independent of each other.
