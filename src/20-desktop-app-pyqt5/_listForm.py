...
# file is never hand-edited. Behavior lives in _list.py.
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        # QListWidget shows a scrollable list of text (or icon) items, one
        # per row, and lets the user select a row. It starts empty here --
        # _list.py's loadStudents() fills it with sample names at startup.
        ...
        # A QVBoxLayout (see layouts.py) stacking the buttons below one on
        # top of another.
        ...
        # Another QSpacerItem (see _dateForm.py), but this time "Expanding"
        # vertically: it soaks up all leftover vertical space in the
        # layout, which pushes the Exit button below it down to the very
        # bottom of the widget instead of leaving it bunched up with the
        # others.
