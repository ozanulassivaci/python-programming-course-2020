...
# file is never hand-edited. Behavior lives in _combobox.py.
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        # QComboBox is a dropdown box: it shows one selected item at a time
        # and pops open a list to pick a different one when clicked. It
        # starts out empty here -- _combobox.py fills it with items at
        # runtime (see load_items()).
